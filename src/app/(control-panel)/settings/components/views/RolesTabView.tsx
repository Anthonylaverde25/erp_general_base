...
export default function RolesTabView() {
    ...
    return (
        <Card className="w-full shadow-sm rounded-lg overflow-hidden border border-gray-200">
            <CardHeader
                title={
                ...
                subheader="Gestione los roles y permisos de acceso"
                action={
                ...
                <Table sx={{ minWidth: 650 }} aria-label="roles table">
                    <TableHead>
                        <TableRow className="bg-gray-50">
                            <TableCell className="font-semibold text-gray-600 pl-6">ID</TableCell>
                            ...
                            <TableCell align="right" className="font-semibold text-gray-600 pr-6">Acciones</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {roles?.map((role) => (
                            ...
                            >
                                <TableCell component="th" scope="row" className="pl-6">
