...
export const registerPartnerModule = (container: Container) => {
    container
        .bind<IPartnerRepository>(TYPES.PartnerRepository)
        .to(PartnerRepositoryCrud);
    container
    ...
    container
        .bind<CreatePartnerUseCase>(TYPES.CreatePartnerUseCase)
        .to(CreatePartnerUseCase);
    container
        .bind<UpdatePartnerUseCase>(TYPES.UpdatePartnerUseCase)
        .to(UpdatePartnerUseCase);
};
