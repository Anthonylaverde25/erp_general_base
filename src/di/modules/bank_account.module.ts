...
export const registerBankAccountModule = (container: Container) => {
	container
		...
		.inSingletonScope();
	container.bind<IndexBankAccountUseCase>(TYPES.IndexBankAccountUseCase).to(IndexBankAccountUseCase);
	container.bind<ShowBankAccountUseCase>(TYPES.ShowBankAccountUseCase).to(ShowBankAccountUseCase);
	container.bind<CreateBankAccountUseCase>(TYPES.CreateBankAccountUseCase).to(CreateBankAccountUseCase);
	container.bind<UpdateBankAccountUseCase>(TYPES.UpdateBankAccountUseCase).to(UpdateBankAccountUseCase);
};
