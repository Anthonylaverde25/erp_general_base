...
export const registerPaymentMethodModule = (container: Container) => {
    ...
    container.bind<IPaymentMethodActionRepository>(TYPES.IPaymentMethodActionRepository).to(PaymentMethodRepositoryAction);
    ...
    container.bind<TogglePaymentMethodStatusUseCase>(TYPES.TogglePaymentMethodStatusUseCase).to(TogglePaymentMethodStatusUseCase);
};
