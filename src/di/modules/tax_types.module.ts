...
export function registerTaxTypesModule(container: Container) {
	// Repository
	container.bind<ITaxTypeRepository>(TYPES.ITaxTypeRepository).to(TaxTypeRepositoryCrud);

	// Use Cases
	container.bind<IndexTaxTypesUseCase>(TYPES.IndexTaxTypesUseCase).to(IndexTaxTypesUseCase);
	container.bind<CreateTaxTypeUseCase>(TYPES.CreateTaxTypeUseCase).to(CreateTaxTypeUseCase);
	container.bind<UpdateTaxTypeUseCase>(TYPES.UpdateTaxTypeUseCase).to(UpdateTaxTypeUseCase);
	container.bind<ToggleTaxTypeStatusUseCase>(TYPES.ToggleTaxTypeStatusUseCase).to(ToggleTaxTypeStatusUseCase);
}
