...
export function registerNumberSeriesModule(container: Container) {
	// Repository
	container.bind<INumberSeriesRepository>(TYPES.INumberSeriesRepository).to(NumberSeriesRepositoryCrud);

	// Use Cases
	container.bind<IndexNumberSeriesUseCase>(TYPES.IndexNumberSeriesUseCase).to(IndexNumberSeriesUseCase);
	container.bind<CreateNumberSeriesUseCase>(TYPES.CreateNumberSeriesUseCase).to(CreateNumberSeriesUseCase);
	container.bind<UpdateNumberSeriesUseCase>(TYPES.UpdateNumberSeriesUseCase).to(UpdateNumberSeriesUseCase);
}
