...
export function registerTaxRatesModule(container: Container) {
    // Repository
    container
        .bind<ITaxRateRepository>(TYPES.ITaxRateRepository)
        .to(TaxRateRepositoryCrud);

    // Use Cases
    container
        .bind<IndexTaxRatesUseCase>(TYPES.IndexTaxRatesUseCase)
        .to(IndexTaxRatesUseCase);
    container
        .bind<CreateTaxRateUseCase>(TYPES.CreateTaxRateUseCase)
        .to(CreateTaxRateUseCase);
    container
        .bind<UpdateTaxRateUseCase>(TYPES.UpdateTaxRateUseCase)
        .to(UpdateTaxRateUseCase);
}
