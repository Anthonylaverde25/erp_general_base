...
export const registerFamilyModule = (container: Container) => {
    ...
    container
        .bind<IFamilyActionRepository>(TYPES.IFamilyActionRepository)
        .to(FamilyRepositoryAction);
    container
        .bind<ToggleFamilyStatusUseCase>(TYPES.ToggleFamilyStatusUseCase)
        .to(ToggleFamilyStatusUseCase);
};
