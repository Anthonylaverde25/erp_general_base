...
export class CreateBankAccountUseCase
	implements IUseCase<ICreateBankAccount, { bank_account: BankAccountEntity; message: string }>
{
	constructor(
	...
	async execute(data: ICreateBankAccount): Promise<{ bank_account: BankAccountEntity; message: string }> {
