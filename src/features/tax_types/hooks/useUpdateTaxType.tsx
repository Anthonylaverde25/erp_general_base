...
export default function useUpdateTaxType() {
	...
	const updateTaxTypeUseCase = container.get<UpdateTaxTypeUseCase>(TYPES.UpdateTaxTypeUseCase);

	const { mutateAsync: handleUpdateTaxType, isPending: isLoading } = useMutation({
