...
export default function useUpdateNumberSeries() {
	...
	const updateNumberSeriesUseCase = container.get<UpdateNumberSeriesUseCase>(TYPES.UpdateNumberSeriesUseCase);

	const { mutateAsync: handleUpdateNumberSeries, isPending: isLoading } = useMutation({
