...
export const useTogglePaymentMethodStatus = () => {
	...
	const togglePaymentMethodStatusUseCase = container.get<TogglePaymentMethodStatusUseCase>(
		TYPES.TogglePaymentMethodStatusUseCase
	);

	return useMutation({
		mutationFn: (params: { id: number; status: boolean }) => togglePaymentMethodStatusUseCase.execute(params),
		onSuccess: () => {
