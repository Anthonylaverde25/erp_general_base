...
export const mapItemFormToDTO = (values: ItemFormType): CreateItemDTO => {
  const baseDTO: CreateItemDTO = {
    ...
    default_supplier_id: values.default_supplier_id
      ? Number(values.default_supplier_id)
      : undefined,
  };
  ...
  if (values.type === "physical") {
    return {
      ...
      physical_profile: {
        ...
        is_inventoriable:
          typeof values.is_inventoriable !== "undefined"
            ? Boolean(values.is_inventoriable)
            : undefined,
      },
    };
  }
  ...
  return {
    ...
    service_profile: {
      estimated_time:
        values.estimated_time !== undefined
          ? Number(values.estimated_time)
          : undefined,
      req_scheduling:
        typeof values.req_scheduling !== "undefined"
          ? Boolean(values.req_scheduling)
          : undefined,
    },
  };
};
