...
import { CreateStoreFormType, createStoreSchema } from '@/schemas/store/store.schema';
...
export default function CreateStoreForm({ onCancel, onSuccess }: CreateStoreFormProps) {
					...
					<form onSubmit={handleSubmit(onSubmit)}>
						<Stack spacing={4}>
							...
							<Box>
								...
								>
									Complete la información para registrar una nueva tienda en el sistema
								</Typography>
							</Box>
