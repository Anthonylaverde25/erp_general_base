...
import { CreateEmployeeModal } from '@/app/(control-panel)/hr/employees/CreateEmployeeModal';
import { EditEmployeeModal } from '@/app/(control-panel)/hr/employees/EditEmployeeModal';
