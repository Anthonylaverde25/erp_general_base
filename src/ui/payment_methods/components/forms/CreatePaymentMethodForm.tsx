...
import { CreatePaymentMethodFormType, createPaymentMethodSchema } from '@/schemas/payment_method/payment_method.schema';
...
export default function CreatePaymentMethodForm({ onCancel, onSuccess }: CreatePaymentMethodFormProps) {
	const { handleCreatePaymentMethod, isLoading } = useCreatePaymentMethod();

	const { control, formState, handleSubmit } = useForm<CreatePaymentMethodFormType>({
		mode: 'onChange',
				...
				<form onSubmit={handleSubmit(onSubmit)}>
					<Stack spacing={4}>
						...
						<Box>
							...
							>
								Complete la información para registrar un nuevo método de pago en el sistema
							</Typography>
						</Box>
