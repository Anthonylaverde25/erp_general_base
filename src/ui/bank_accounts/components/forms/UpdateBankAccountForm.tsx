...
import { UpdateBankAccountFormType, updateBankAccountSchema } from '@/schemas/bank_account/bank_account.schema';
...
export default function UpdateBankAccountForm({ bankAccount, onCancel, onSuccess }: UpdateBankAccountFormProps) {
	const { handleUpdateBankAccount, isLoading } = useUpdateBankAccount();

	const { control, formState, handleSubmit, reset } = useForm<UpdateBankAccountFormType>({
		mode: 'onChange',
