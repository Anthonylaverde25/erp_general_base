	...
	return (
		<Box>
			<SectionHeader
				...
				subtitle="Selecciona el diseño para tus facturas PDF"
			/>
					...
					>
						...
						>
							<Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
								...
								<Box sx={{ textAlign: 'right' }}>
									<Box
										sx={{ height: 6, width: 60, bgcolor: 'grey.300', borderRadius: 0.5, mb: 0.5 }}
									/>
							...
							<Box sx={{ mt: 'auto' }}>
								<Box
									sx={{ height: 4, width: '100%', bgcolor: 'grey.200', borderRadius: 0.5, mb: 0.5 }}
								/>
								<Box
									sx={{ height: 4, width: '85%', bgcolor: 'grey.200', borderRadius: 0.5, mb: 0.5 }}
								/>
						...
						<Box sx={{ mt: 2 }}>
							<Typography
								...
								sx={{
									fontWeight: 600,
									color: designType === 'professional' ? 'primary.main' : 'text.primary',
									mb: 0.5
								}}
							>
								Professional
					...
					>
						...
						<Box sx={{ mt: 2 }}>
							<Typography
								...
								sx={{
									fontWeight: 600,
									color: designType === 'classic' ? 'primary.main' : 'text.primary',
									mb: 0.5
								}}
							>
								Classic
					...
					>
						...
						>
							...
							<Box sx={{ mt: 'auto', pt: 1, borderTop: 1, borderColor: 'grey.300' }}>
								<Box
									sx={{ height: 5, width: 45, bgcolor: 'grey.400', borderRadius: 0.5, ml: 'auto' }}
								/>
							</Box>
						</Box>
						...
						<Box sx={{ mt: 2 }}>
							<Typography
								...
								sx={{
									fontWeight: 600,
									color: designType === 'minimal' ? 'primary.main' : 'text.primary',
									mb: 0.5
								}}
							>
								Minimal
