						...
						<View style={[styles.tableRow, index % 2 === 1 ? styles.tableRowEven : {}]}>
							<View style={[styles.colIndex, cellStyle, { backgroundColor: '#f8fafc' }]}>
								<Text
									style={[
										styles.itemBold,
										{ color: SECONDARY_COLOR, fontSize: 8, textAlign: 'center', width: '100%' }
									]}
								>
									{index + 1}
								</Text>
							...
							<View style={[colDescStyle, cellStyle]}>
								<Text style={[styles.itemMain, { textAlign: 'left', width: '100%' }]}>{line.name}</Text>
							</View>

							<View style={[styles.colQty, cellStyle]}>
								<Text style={[styles.itemValueBold, { textAlign: 'center', width: '100%' }]}>
