...
import { CreateRoleFormType, createRoleSchema, defaultCreateRoleValues } from '@/schemas/role/role.schema';
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <Stack spacing={4}>
                        ...
                        <Box>
                            ...
                            >
                                Complete la información para registrar un nuevo rol en el sistema
                            </Typography>
                        </Box>
