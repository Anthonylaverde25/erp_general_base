                        ...
                        <form className="flex flex-col gap-8">
                            ...
                            <div className="flex flex-col gap-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-12 gap-6">
                                    ...
                                    <div className="col-span-12 flex flex-wrap gap-6 items-center pt-2">
                                        ...
                                        <Controller
                                            ...
                                            render={({ field }) => (
                                                <FormControlLabel
                                                    ...
                                                    label={<Typography variant="body2" fontWeight={500}>Crédito Disponible</Typography>}
                                                />
                                            )}
                                        />
                                        <Controller
                                            ...
                                            render={({ field }) => (
                                                <FormControlLabel
                                                    ...
                                                    label={<Typography variant="body2" fontWeight={500}>Facturación Agrupada</Typography>}
                                                />
                                            )}
                                        />
                                    </div>
                                    ...
                                    <div className="col-span-12 pt-2">
                                        <Typography variant="subtitle2" className="mb-3 text-text-secondary font-medium">Rol del Socio</Typography>
                                        <Controller
                                            name="role"
                                            control={control}
                                            render={({ field }) => (
                            ...
                            <div className="pt-6 border-t border-dashed">
                                ...
                                <div className="space-y-4">
                                    {bankAccountsFields.length === 0 && (
                                        <div className="text-center py-8 text-text-secondary italic bg-gray-50 dark:bg-gray-800 rounded-lg border border-dashed border-gray-300 dark:border-gray-700">
                                    ...
                                    {bankAccountsFields.map((item, index) => {
                                        ...
                                        return (
                                            <div
                                                key={item.id}
                                                className={`p-5 rounded-lg border transition-all duration-200 ${isDefault
                                                ...
                                                <div className="flex items-center justify-between mb-4">
                                                    <Controller
                                                        ...
                                                        render={({ field }) => (
                                                            ...
                                                            >
                                                                <div className={`w-4 h-4 rounded-full border flex items-center justify-center mr-2 transition-colors ${field.value ? 'border-secondary bg-secondary' : 'border-gray-400 bg-transparent group-hover:border-secondary'}`}>
                                                                    {field.value && <div className="w-1.5 h-1.5 rounded-full bg-white" />}
                                                                </div>
                                                                <span className={`text-sm font-medium ${field.value ? 'text-secondary' : 'text-text-secondary group-hover:text-secondary'}`}>
                                                                    {field.value ? 'Principal' : 'Marcar como Principal'}
                                                                </span>
                                                            </div>
                                                        )}
                                                    />
                            ...
                            <div className="pt-6 border-t border-dashed">
                                ...
                                {(showSaleTaxes || showPurchaseTaxes) && (
                                    <div className="pt-6">
                                        <Typography variant="subtitle2" fontWeight={600} className="mb-4 text-text-primary uppercase tracking-wide text-xs">
                                        ...
                                        <div className={`grid gap-8 ${showSaleTaxes && showPurchaseTaxes ? 'grid-cols-1 md:grid-cols-2' : 'grid-cols-1'}`}>
                                            {showSaleTaxes && (
                                                <div>
                                                    <Typography variant="body2" fontWeight={500} className="mb-2 flex items-center gap-2 text-text-secondary">
